...
_G.packer_plugins = {
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/nord-vim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/vim-bbye",
    url = "https://github.com/moll/vim-bbye"
  },
  ["vim-startify"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/vim-startify",
